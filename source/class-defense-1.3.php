...
class defense {
  ...
  function checkSpeed() {
    ...
    if(!isset($_SESSION["amount_requests_last_minute"]) || $_SESSION["amount_requests_last_minute"] < (time()-60) ) {
      $_SESSION["amount_requests_last_minute"] = time();
    }
    $_SESSION["amount_requests_last_minute"] += 1;
    if($_SESSION["amount_requests_last_minute"] > 100) { // Sample value
